...
struct Tensor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  TensorType type() const {
      fprintf(stderr, "Tensor VT_TYPE=6 ");
    return static_cast<TensorType>(GetField<int8_t>(VT_TYPE, 0));
  }
  uint32_t buffer() const {
      fprintf(stderr, "Tensor VT_BUFFER=8 ");
...
struct Conv2DOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  int32_t stride_w() const {
      fprintf(stderr, "Conv2DOptions VT_STRIDE_W=6 ");
    return GetField<int32_t>(VT_STRIDE_W, 0);
  }
  int32_t stride_h() const {
      fprintf(stderr, "Conv2DOptions VT_STRIDE_H=8 ");
...
struct OperatorCode FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  BuiltinOperator builtin_code() const {
      fprintf(stderr, "OperatorCode VT_BUILTIN_CODE=4 ");
  ...
  int32_t version() const {
      fprintf(stderr, "OperatorCode VT_VERSION=8 ");
...
struct Operator FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint32_t opcode_index() const {
      fprintf(stderr, "OperatorCode VT_OPCODE_INDEX=4 ");
...
struct Model FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  uint32_t version() const {
      fprintf(stderr, "Model VT_VERSION=4 ");

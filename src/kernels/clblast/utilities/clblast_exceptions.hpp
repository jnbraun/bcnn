...
//
// This file implements the exception hierarchy for CLBlast. It contains classes
// for exceptions generated by different parts of CLBlast (e.g. OpenCL API
// calls, internal logic, semantic BLAS errors).
//
// =================================================================================================
...
class BLASError : public ErrorCode<Error<std::invalid_argument>, StatusCode> {
   public:
    explicit BLASError(StatusCode status,
                       const std::string &subreason = std::string{});
};
// =================================================================================================
...
class RuntimeErrorCode : public ErrorCode<RuntimeError, StatusCode> {
   public:
    explicit RuntimeErrorCode(StatusCode status,
                              const std::string &subreason = std::string{});
};
